...
export default async function handler(req, res) {
  ...
  var options = {
    url: "https://api.spotify.com/v1/shows/2B4z0QYgLOsqYCEdPAHnxw/episodes/?market=LV&limit=50&offset=50",
    headers: {
  ...
  const result = await fetch(
    "https://api.spotify.com/v1/shows/2B4z0QYgLOsqYCEdPAHnxw/episodes/?market=LV&limit=50&offset=50",
    {
      headers: {
        Authorization: "Bearer " + token,
        "Content-Type": "application/x-www-form-urlencoded",
